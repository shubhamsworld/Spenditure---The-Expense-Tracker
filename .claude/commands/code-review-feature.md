...
description: Runs parallel security and quality code 
  review for a specific Spenditure feature. Pass the spec 
...
**spenditure-security-reviewer** receives:
...
**spenditure-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[spenditure-security-reviewer output]
Quality Findings
[spenditure-quality-reviewer output]
