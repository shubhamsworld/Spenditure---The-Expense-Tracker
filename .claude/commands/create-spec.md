---
description: Create a spec file and feature branch for the next Spenditure step
...
Spenditure expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the Spenditure roadmap.
