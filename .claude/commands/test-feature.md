---
description: Writes and runs tests for a specific Spenditure feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **spenditure-test-writer** subagent with the 
following context:
...
Wait for spenditure-test-writer to fully complete and 
...
Once spenditure-test-writer has finished, invoke the 
**spenditure-test-runner** subagent with the following 
context:
...
- If spenditure-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the spenditure-test-runner's structured report
